...
Java_com_sik_sikencrypt_EncryptUtils_AESEncode(JNIEnv *env, jobject thiz, jstring key,
                                               jstring content) {
...
Java_com_sik_sikencrypt_EncryptUtils_AESDecode(JNIEnv *env, jobject thiz, jstring key,
                                               jstring content) {
    uint8_t *keyData = jstringTostring(env,key);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_sik_sikencrypt_EncryptUtils_MD5Encode(JNIEnv *env, jobject thiz, jstring content) {
    const char *str = env->GetStringUTFChars(content, 0);
